        ...
        <div className="left-section">
          ...
          <div className="signup-box">
            ...
            <form onSubmit={handleSignup}>
              <div className="role-selection">
                <button type="button" className={`role-btn ${role === "recruiter" ? "selected" : ""}`} onClick={() => setRole("recruiter")}>Recruiter</button>
                <button type="button" className={`role-btn ${role === "jobseeker" ? "selected" : ""}`} onClick={() => setRole("jobseeker")}>Job Seeker</button>
              </div>
